...
- [ ] Слой вышек выбранных операторов в видимой области: импорт bulk-дампа OpenCelliD (CC BY-SA, атрибуция) → локальная таблица → вьюпорт-запросы + чекбоксы операторов (Фаза 4.7)
