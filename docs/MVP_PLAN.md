...
- [x] Фикс видимости слоя: радиус маркеров по ярусам зума (60/25/12 м) + белая обводка, загрузка при onMapCreated, диагностика «Вышек в области: N (база: M)», ошибки в debugPrint + SnackBar
