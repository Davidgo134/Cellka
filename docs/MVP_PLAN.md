...
- [ ] Скорость соединения (спидтест), CA-агрегации — волна 3, см. ROADMAP.md
...
- [x] Кластеризация маркеров (flutter_map_marker_cluster: пузырь-счётчик, maxClusterRadius 45, тап приближает). Развитие — ROADMAP.md, волна 1
- [ ] Band/частоты у вышки из собственных замеров — волна 2, см. ROADMAP.md
